...
#define VM_CALL_STACK_BASE 0x00008000u
#define VM_CALL_STACK_ENTRIES 2048u
#define VM_CALL_STACK_BYTES (VM_CALL_STACK_ENTRIES * 8u)
#define VM_DATA_STACK_BASE (VM_CALL_STACK_BASE + VM_CALL_STACK_BYTES)
#define VM_DATA_STACK_ENTRIES 2048u
#define VM_DATA_STACK_BYTES (VM_DATA_STACK_ENTRIES * 4u)
#define VM_DATA_STACK_RESERVED_BYTES (VM_DATA_STACK_ENTRIES * 8u)
#define VM_ISR_STACK_BASE (VM_DATA_STACK_BASE + VM_DATA_STACK_RESERVED_BYTES)
#define VM_ISR_STACK_ENTRIES 2048u
...
#define IRQ_ETHER 0x06u
#define IRQ_GPU 0x07u
#define IRQ_AUDIO 0x08u
#define IRQ_SYSCALL 0x80u
#define IRQ_USER_EXEC_ENTER 0x81u

#define TIMER_MMIO_BASE (VM_ISR_STACK_BASE + VM_ISR_STACK_BYTES)
...
#define PCI_MMIO_ALLOC_BASE 0x00A00000u
#define PCI_MMIO_ALLOC_LIMIT 0x01000000u
...
#define BOOTINFO_FEATURE_ETHER (1u << 8)
#define BOOTINFO_FEATURE_PCIE (1u << 9)
#define BOOTINFO_FEATURE_RUNTIME_STATS (1u << 10)
